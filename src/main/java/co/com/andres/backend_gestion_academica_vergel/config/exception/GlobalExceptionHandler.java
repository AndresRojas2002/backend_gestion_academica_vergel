...
import co.com.andres.backend_gestion_academica_vergel.config.exception.enrollmentException.EnrollmentByStateException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.enrollmentException.EnrollmentWithDateValidException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.enrollmentException.EnrollmentWithIdCourseValidException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.enrollmentException.EnrollmentWithIdSudentValidException;
...
import co.com.andres.backend_gestion_academica_vergel.config.exception.professorException.ProfessorWithEmailValidException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.professorException.ProfessorWithPhoneValidException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.professorException.ProfessorWithRoleValidException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.studentException.StudentByIdException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.studentException.StudentNumberExistException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.studentException.StudentWintNumberValidExeption;
import co.com.andres.backend_gestion_academica_vergel.config.exception.studentException.StudentWintPhoneValidException;
...
import co.com.andres.backend_gestion_academica_vergel.config.exception.subjectException.SubjectCodeValidException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.subjectException.SubjectMaxCapacityValidException;
import co.com.andres.backend_gestion_academica_vergel.config.exception.subjectException.SubjectWithCodeExistException;
...
public class GlobalExceptionHandler {
         ...
         */
        @ExceptionHandler
        public ResponseEntity<ApiErrorResponse> handlerCourseByIdException(SubjectByIdException ex,
                        HttpServletRequest request) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                                .body(new ApiErrorResponse(HttpStatus.NOT_FOUND, ex.getMessage(),
                                                request.getRequestURI()));
         ...
         */
        @ExceptionHandler
        public ResponseEntity<ApiErrorResponse> handlerCourseWithCodeExistException(SubjectWithCodeExistException ex,
                        HttpServletRequest request) {
                return ResponseEntity.status(HttpStatus.CONFLICT)
                                .body(new ApiErrorResponse(HttpStatus.CONFLICT, ex.getMessage(),
                                                request.getRequestURI()));
         ...
         */
        @ExceptionHandler
        public ResponseEntity<ApiErrorResponse> handlerCourseCodeValidException(SubjectCodeValidException ex,
                        HttpServletRequest request) {
                return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                                .body(new ApiErrorResponse(HttpStatus.BAD_REQUEST, ex.getMessage(),
                                                request.getRequestURI()));
        ...
        public ResponseEntity<ApiErrorResponse> handlerCourseMaxCapacityValidException(
                        SubjectMaxCapacityValidException ex,
                        HttpServletRequest request) {
                return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                                .body(new ApiErrorResponse(HttpStatus.BAD_REQUEST, ex.getMessage(),
                                                request.getRequestURI()));
        ...
        public ResponseEntity<ApiErrorResponse> handlerInvalidCredentialsProfessorException(
                        co.com.andres.backend_gestion_academica_vergel.config.exception.authenticate.InvalidCredentialsProfessorException ex,
                        HttpServletRequest request) {
        ...
        public ResponseEntity<ApiErrorResponse> handlerInvalidCredentialsStudentException(
                        co.com.andres.backend_gestion_academica_vergel.config.exception.authenticate.InvalidCredentialsStudentException ex,
                        HttpServletRequest request) {
                return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                .body(new ApiErrorResponse(HttpStatus.UNAUTHORIZED, ex.getMessage(),
                                                request.getRequestURI()));
